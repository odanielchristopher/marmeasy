      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            className={cn(
              'w-[200px] justify-between bg-white dark:bg-accent border-gray-500 dark:border-accent focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] hover:bg-white relative pt-5',
              classNames?.trigger,
            )}
          >
            <span
