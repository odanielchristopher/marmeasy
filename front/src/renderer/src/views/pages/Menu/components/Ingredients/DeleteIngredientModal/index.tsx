...
export default function DeleteIngredientModal({ open, onClose, ingredient }: DeleteIngredientModalProps) {
  const { handleConfirm, isloading } = useDeleteIngredientModal(ingredient, onClose);
  ...
  return (
    ...
    >
      <Container>
       <Warning>
        Tem certeza que deseja excluir a ingrediente?
       </Warning>
