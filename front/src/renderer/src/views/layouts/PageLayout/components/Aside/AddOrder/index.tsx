                ...
                <footer>
                    <ul className='categoriesOptions'>
                        {categories.map((category) => (
                            <IconCategory key={category.id} onClick={() => setSelectedCategory(category)} className={selectedCategory?.id === category.id ? 'active' : ''}>
                    ...
                    <ul className='productsOptions'>
                        {selectedCategory &&  products.filter((product) => product.category.id === selectedCategory.id).map((product) => {
                                ...
                                <ProductList key={product.id}>
                                    {product.imagePath ? <img src={imagePath} /> : <img src={noImage} alt="No image" />}
                                    <div className='infos'>
